...
const PARAM_GROUPS = [
  ...
  },
  {
    ...
    fields:[
      ...
      { key:"sr_min_touches",        label:"S/R Min Touches",    unit:"touches",        min:1,      max:6,       step:1,      tip:"Minimum times price tested the S/R level." },
      { key:"sr_lookback_days",      label:"S/R Recency",        unit:"days",           min:7,      max:90,      step:1,      tip:"At least one touch must be within this many days." },
      { key:"sr_proximity_pct",      label:"S/R Proximity",      unit:"% from level",  min:0.5,    max:5,       step:0.25,   tip:"Price must be within this % of the S/R level." },
      { key:"earnings_blackout_days",label:"Earnings Blackout",  unit:"days",           min:5,      max:45,      step:1,      tip:"Short strategies excluded if earnings fall within N days." },
    ],
  },
  {
    ...
    fields:[
      ...
      { key:"lc_catalyst_min_days", label:"Catalyst Min",  unit:"days to earn", min:3,   max:14,  step:1,   tip:"Earnings bonus window start." },
      { key:"lc_catalyst_max_days", label:"Catalyst Max",  unit:"days to earn", min:14,  max:45,  step:1,   tip:"Earnings bonus window end." },
  ...
  },
  {
    ...
    fields:[
      ...
      { key:"lp_catalyst_min_days", label:"Catalyst Min",  unit:"days to earn", min:3,   max:14,  step:1,   tip:"Earnings bonus window start." },
      { key:"lp_catalyst_max_days", label:"Catalyst Max",  unit:"days to earn", min:14,  max:45,  step:1,   tip:"Earnings bonus window end." },
    ],
  },
  {
